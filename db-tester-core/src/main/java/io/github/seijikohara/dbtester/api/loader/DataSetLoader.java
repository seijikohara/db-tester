...
public interface DataSetLoader {
   ...
   * @return immutable list of datasets to load into the database, never null
   */
  List<ScenarioDataSet> loadPreparationDataSets(final TestContext context);
   ...
   *
   * @param context the test execution context containing test metadata and configuration
   * @return immutable list of datasets to validate against the database, never null
   */
  List<ScenarioDataSet> loadExpectationDataSets(final TestContext context);
}
