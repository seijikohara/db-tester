 ...
 *
 * <p>This SPI abstracts the underlying database testing implementation (e.g., DbUnit) and allows
 * the API module to remain independent of specific implementations. The actual implementation is
 * provided by the core module and loaded via {@link java.util.ServiceLoader}.
 *
 ...
 */
public interface DatabaseBridgeProvider {
