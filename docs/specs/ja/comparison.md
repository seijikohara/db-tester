...
|--------------|----------|------------|
| **DB Tester** | JUnit 6/Spock 2/Kotest 6での規約ベーステスト | CSV/TSV/JSON/YAMLサポート、新しいプロジェクト |
...
| データセットエクスポート | Yes | Yes | Yes | - | - | Yes |
| 置換/プレースホルダー | Yes | Yes | Yes | - | - | - |
| スクリプト可能データセット | Yes | - | Yes | - | - | - |
| コネクションリーク検出 | - | - | Yes | - | - | - |
| SPI拡張性 | Yes | - | - | - | - | - |
...
| **発展中のドキュメント** | 例と仕様書を拡充中 | 仕様書とサンプルモジュールを参照 |
