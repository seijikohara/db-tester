...
|----------|-------------|
| [01-OVERVIEW.md](01-OVERVIEW.md) | High-level framework overview and key concepts |
| [02-ARCHITECTURE.md](02-ARCHITECTURE.md) | Module structure, dependencies, and architectural patterns |
| [03-PUBLIC-API.md](03-PUBLIC-API.md) | Annotations, interfaces, and domain value objects |
| [04-CONFIGURATION.md](04-CONFIGURATION.md) | Configuration classes and options |
| [05-DATA-FORMATS.md](05-DATA-FORMATS.md) | CSV/TSV file structure and parsing rules |
| [06-DATABASE-OPERATIONS.md](06-DATABASE-OPERATIONS.md) | Supported database operations and execution flow |
| [07-TEST-FRAMEWORKS.md](07-TEST-FRAMEWORKS.md) | JUnit and Spock integration details |
| [08-SPI.md](08-SPI.md) | Service Provider Interface extension points |
| [09-ERROR-HANDLING.md](09-ERROR-HANDLING.md) | Error messages and exception handling |
