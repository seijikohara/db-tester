...
[Maven Central](https://central.sonatype.com/artifact/io.github.seijikohara/db-tester-kotest-spring-boot-starter).
...
Register `SpringBootDatabaseTestExtension` in the `init` block. The extension registers the DataSource from the
